...
def train(args, params):
    ...
    #scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer,T_max=args.epochs,eta_min=params['lr1'] * params['lrf'])
    ...
    if args.resume:
        ...
        if args.model_path is not None:
            ...
            start_epoch = 0
            # checkpoint = torch.load('./weights/last_640_1e-2_0.002_1.0_3dec.pt', map_location='cuda')['model'].state_dict()
    ...
    # dehaze_criterion = []
    # dehaze_criterion.append(torch.nn.L1Loss())
    # dehaze_criterion.append(util.ContrastLoss_res(ablation=False).cuda())

...
import sys
sys.path.append(r'c:\Users\Lenovo\Desktop\MMU\FYP\Code\Yolov9')
...
class SqueezeExciteBlock(torch.nn.Module):
    def __init__(self, channels):
        ...
        self.fc1 = torch.nn.Conv2d(channels, channels // 8, kernel_size=1)
        self.relu = torch.nn.ReLU(inplace=True)
        self.fc2 = torch.nn.Conv2d(channels // 8, channels, kernel_size=1)
...
#     sample_input = torch.randn(batch_size, image_channels, image_height, image_width)
#     sample_input = sample_input.float() / 255
#     detection,dehaze = model(sample_input)
#     print(dehaze.shape)
#     # print(model)